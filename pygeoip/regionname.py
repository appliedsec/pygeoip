...
_country = {
    ...
    "GB": {
        ...
        1094: "Kent",
        1095: "Kingston upon Hull, City of",
        ...
        1699: "Edinburgh, City of",
        1909: "Vale of Glamorgan, The",
        1908: "Torfaen",
        1737: "Highland",
        1823: "Bridgend",
        1779: "Renfrewshire",
    ...
    "US": {
        ...
        852: "Armed Forces Europe, Middle East, & Canada",
        981: "Delaware",
        1367: "Maryland",
        1368: "Maine",
        1625: "South Dakota",
    ...
    "SI": {
        ...
        66: "Loski Potok",
        68: "Lukovica",
        1093: "Dobrova-Horjul-Polhov Gradec",
        71: "Medvode",
        72: "Menges",
        73: "Metlika",
        74: "Mezica",
        ...
        1305: "Ribnica",
        1307: "Ruse",
        1311: "Sentjur pri Celju",
        1312: "Slovenska Bistrica",
        832: "Radenci",
        833: "Radlje ob Dravi",
        834: "Radovljica",
        837: "Rogasovci",
        ...
        918: "Skofljica",
        919: "Slovenj Gradec",
        921: "Slovenske Konjice",
        922: "Smarje pri Jelsah",
        923: "Smartno ob Paki",
        924: "Sostanj",
        925: "Starse",
        926: "Store",
...
def region_name_by_country_and_region_code(country_code, region_code):
    if country_code not in _country:
        return None

    if isinstance(region_code, str) or isinstance(region_code, unicode):
        region_code = int(region_code)

    return _country[country_code].get(region_code)
